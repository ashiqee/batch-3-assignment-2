...
const getSignleProductFromDB = (productId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield products_model_1.ProductsModel.findOne({ _id: productId });
    return result;
});
const updateAProductIntoDB = (updateProductData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        //validation update product
        const parsedProduct = productValidation_1.productValidationSchema.parse(updateProductData.data);
        const result = yield products_model_1.ProductsModel.findByIdAndUpdate({ _id: updateProductData._id }, parsedProduct, {
            new: true,
            runValidators: true,
        });
        return result;
...
const deleteAProductFromDB = (productId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield products_model_1.ProductsModel.findByIdAndDelete(productId);
        return result;
    }
    catch (err) {
        console.log(err);
...
const orderInventoryUpdateInDB = (productId, orderQuantity) => __awaiter(void 0, void 0, void 0, function* () {
