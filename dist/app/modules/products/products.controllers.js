...
const getAllProducts = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const result =
        yield products_service_1.ProductsServices.getAllProductsFromDB(
          searchTerm
        );
      if (result.length === 0) {
...
//get single Product
const getSignleProduct = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { productId } = req.params;
      const result =
        yield products_service_1.ProductsServices.getSignleProductFromDB(
          productId
        );
      if (!result) {
        return res.status(404).json({
...
const updateAProduct = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const result =
        yield products_service_1.ProductsServices.updateAProductIntoDB(
          updateProductData
        );
      if (!result) {
        return res.status(404).json({
...
const deleteAProduct = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { productId } = req.params;
      const result =
        yield products_service_1.ProductsServices.deleteAProductFromDB(
          productId
        );
      if (!result) {
        return res.status(404).json({
